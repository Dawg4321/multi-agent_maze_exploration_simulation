...
parent_directory = "/home/ryan/maze_simulations/location_test/"
...
for i in group_sizes: # iterate through the various robot swarm sizes
...
plt.title("Maze mapping performance of " + str(num_of_robots) + " agents as group size increases")
