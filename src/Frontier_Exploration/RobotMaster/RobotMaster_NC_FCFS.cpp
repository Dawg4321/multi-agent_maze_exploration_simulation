...
RobotMaster_NC_FCFS::RobotMaster_NC_FCFS(RequestHandler* r, int num_of_robots, unsigned int xsize, unsigned int ysize): RobotMaster(r, num_of_robots, xsize, ysize){

}

RobotMaster_NC_FCFS::~RobotMaster_NC_FCFS(){

}

void RobotMaster_NC_FCFS::handleIncomingRequest(Message* incoming_request){
